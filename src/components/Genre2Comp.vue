<template>
  <div id="app">
    <v-app>
      <div class="main">
        <div class="mainPic-genre2"></div>
        <v-row class="text-h5 pt-8 mb-2" justify="center"><span>LIFEHACK</span></v-row>
        <div class="postList">
          <div v-if="store.apiData && store.apiData.List">
            <v-row class="postsRow" dense justify="center">
              <v-col v-for="post in store.lifehackPosts" :key="post.id" cols="4">
...
.mainPic-genre2 {
  height: 650px;
  background-image: url(https://i.pinimg.com/originals/ed/8c/10/ed8c10ac4859635ecb579c79bf63a0d4.jpg);
